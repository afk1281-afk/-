...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <div style={{ marginTop: 20, textAlign: 'center', fontFamily: 'var(--font-rubik)', fontSize: 14 }}>
        <Link href="/reset-password" style={{ color: '#E8521A', textDecoration: 'none', fontWeight: 500 }}>
          שכחת סיסמה?
        </Link>
      </div>

      <div style={{ marginTop: 12, textAlign: 'center', fontFamily: 'var(--font-rubik)', fontSize: 14, color: '#4A5A6E' }}>
        אין לך חשבון?{' '}
        <Link href="/register" style={{ color: '#1B5FAD', fontWeight: 600, textDecoration: 'none' }}>
          הרשמה
        </Link>
      </div>
    </>
